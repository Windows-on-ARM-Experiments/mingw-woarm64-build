...
OPENBLAS_PATH=${OPENBLAS_PATH:-~/openblas}
OPENBLAS_BUILD_PATH=${OPENBLAS_BUILD_PATH:-$BUILD_PATH/openblas}
OPENBLAS_TESTS_PATH=${OPENBLAS_TESTS_PATH:-$OPENBLAS_BUILD_PATH}
...
OPENSSL_BUILD_PATH=${OPENSSL_BUILD_PATH:-$BUILD_PATH/openssl}
OPENSSL_TESTS_PATH=${OPENSSL_TESTS_PATH:-$OPENSSL_BUILD_PATH}
...
LIBJPEG_TURBO_BUILD_PATH=${LIBJPEG_TURBO_BUILD_PATH:-$BUILD_PATH/libjpeg-turbo}
LIBJPEG_TURBO_TESTS_PATH=${LIBJPEG_TURBO_TESTS_PATH:-$LIBJPEG_TURBO_BUILD_PATH}
