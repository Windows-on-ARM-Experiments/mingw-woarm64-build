...
CHECK_MAKE_OPTIONS=${CHECK_MAKE_OPTIONS:-V=1 -j$(nproc)}
...
GMP_REPO=${GMP_REPO:-https://gmplib.org/download/gmp/gmp-6.3.0.tar.bz2}
GMP_BRANCH=${GMP_BRANCH:-}
GMP_PATH=${GMP_PATH:-~/gmp-$TARGET}
GMP_TESTS_PATH=${GMP_TESTS_PATH:-~/gmp-tests-$TARGET}
