...
if [ $LAUNCH -eq 1 ] || [ $DEBUG -eq 1 ]; then
    ...
    # g
    # sxe -c ".echo vcpp occurred" vcpp
    # sxe -c ".echo dbce occurred" dbce
    # sxe -c ".echo wkd occurred" wkd
    # sxe -c ".echo wob occurred" wob
    # sxe -c ".echo bpe occurred" bpe
    # sxe -c ".echo clr occurred" clr
    # sxe -c ".echo cpr:? occurred" cpr:?
    # sxe -c ".echo ld:cygwin1 occurred" ld:cygwin1
    # sxe -c ".echo ibp occurred" ibp
    # sxe -c ".echo iml occurred" iml
