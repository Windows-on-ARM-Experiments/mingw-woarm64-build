...
use_va_args:
	...
	str	x6, [sp, 256]	;#,
	str	x7, [sp, 264]	;#,
;# varargs-clang-issue-dll.c:22:   va_start (argv, format);
	add	x0, sp, 272	;# tmp128,,
	sub	x0, x0, #56	;# tmp129, tmp128,
	str	x0, [sp, 24]	;# tmp129, MEM[(char * *)&argv]
;# varargs-clang-issue-dll.c:23:   int a = va_arg (argv, struct not_short_vector_12_bytes).a;
...
;# varargs-clang-issue-dll.c:24:   int b = va_arg (argv, struct not_short_vector_12_bytes).b;
...
;# varargs-clang-issue-dll.c:25:   int c = va_arg (argv, struct not_short_vector_12_bytes).c;
...
;# varargs-clang-issue-dll.c:26:   int d = va_arg (argv, struct not_short_vector_12_bytes).a;
...
;# varargs-clang-issue-dll.c:27:   int e = va_arg (argv, struct not_short_vector_12_bytes).b;
...
;# varargs-clang-issue-dll.c:28:   int f = va_arg (argv, struct not_short_vector_12_bytes).c;
...
;# varargs-clang-issue-dll.c:29:   int g = va_arg (argv, struct not_short_vector_12_bytes).a;
...
;# varargs-clang-issue-dll.c:30:   int h = va_arg (argv, struct not_short_vector_12_bytes).b;
...
;# varargs-clang-issue-dll.c:31:   int i = va_arg (argv, struct not_short_vector_12_bytes).c;
...
;# varargs-clang-issue-dll.c:33:   return a + b + c + d + e + f + g + h + i;
...
use_va_list:
	...
	str	x0, [sp, 8]	;# format, format
	str	x1, [sp]	;# argv, argv
;# varargs-clang-issue-dll.c:39:   int a = va_arg (argv, struct not_short_vector_12_bytes).a;
...
;# varargs-clang-issue-dll.c:40:   int b = va_arg (argv, struct not_short_vector_12_bytes).b;
...
;# varargs-clang-issue-dll.c:41:   int c = va_arg (argv, struct not_short_vector_12_bytes).c;
...
;# varargs-clang-issue-dll.c:42:   int d = va_arg (argv, struct not_short_vector_12_bytes).a;
...
;# varargs-clang-issue-dll.c:43:   int e = va_arg (argv, struct not_short_vector_12_bytes).b;
...
;# varargs-clang-issue-dll.c:44:   int f = va_arg (argv, struct not_short_vector_12_bytes).c;
...
;# varargs-clang-issue-dll.c:45:   int g = va_arg (argv, struct not_short_vector_12_bytes).a;
...
;# varargs-clang-issue-dll.c:46:   int h = va_arg (argv, struct not_short_vector_12_bytes).b;
...
;# varargs-clang-issue-dll.c:47:   int i = va_arg (argv, struct not_short_vector_12_bytes).c;
...
;# varargs-clang-issue-dll.c:48:   return a + b + c + d + e + f + g + h + i;
