...
#define DECLARE_TEST(name)                                                    \
  int use_va_args_##name (const char *name, ...);                             \
  int use_va_list_##name (const char *name, va_list argv);                    \
  ...
  {                                                                           \
    ...
    va_end (argv);                                                            \
    printf ("\tuse_va_list_%s, result: %d\n", #name, retval);                 \
    return retval;                                                            \
  }                                                                           \
  ...
  {                                                                           \
    int retval = func (#name, argv);                                          \
    printf ("\tuse_va_list_%s_indirect, result: %d\n", #name, retval);        \
    return retval;                                                            \
  }                                                                           \
...
#define TEST(name, expected, ...)                                             \
  ...
  {                                                                           \
    ...
    printf ("\tuse_va_args_%s result: %d\n", #name, actual);                  \
    assert (expected, actual);                                                \
  }
...
{
  printf ("\tshort_vector_8_bytes size: %lu\n"
